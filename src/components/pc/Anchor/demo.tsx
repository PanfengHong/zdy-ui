...
const AnchorDemo = () => {
  ...
  return (
    <>
      ...
      <div className="component-group">
        <h3>自定义滚动容器（getContainer）</h3>
        <DemoBlock code={`<Anchor getContainer={() => scrollRef.current}>`}>
          <div style={{ display: 'flex', gap: 24, height: 260 }}>
            <div style={{ width: 160, flexShrink: 0 }}>
      ...
      <div className="component-group">
        <h3>嵌套链接</h3>
        <DemoBlock code={`<AnchorLink href="#parent" title="父级">\n  <AnchorLink href="#child" title="子级" />\n</AnchorLink>`}>
          <div style={{ display: 'flex', gap: 24, height: 260 }}>
      ...
      <div className="component-group">
        <h3>水平方向</h3>
        <DemoBlock code={`<Anchor direction="horizontal">`}>
      ...
      <div className="component-group">
        <h3>使用 items 数据</h3>
        <DemoBlock code={`<Anchor items={[{ href: '#x', title: 'X' }]} />`}>
      ...
      <div className="component-group">
        <h3>监听变化（onChange + onClick）</h3>
        <div style={{ marginBottom: 12 }}>
          <span>当前激活：</span>
          <strong style={{ color: '#1890ff' }}>{currentLink || '无'}</strong>
        </div>
        <DemoBlock code={`<Anchor onChange={setCurrentLink} onClick={(e, link) => console.log(link)}>`}>
      ...
      <div className="component-group">
        <h3>带 offsetTop 偏移</h3>
        <DemoBlock code={`<Anchor offsetTop={20}>`}>
          <div style={{ display: 'flex', gap: 24, height: 200 }}>
            <div style={{ width: 160, flexShrink: 0 }}>
              <Anchor
                offsetTop={20}
