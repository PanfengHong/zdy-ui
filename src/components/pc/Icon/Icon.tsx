...
const IconSvg = ({ type, size }: { type: string; size: number }) => {
  const iconSize = size;
  ...
  switch (type) {
    ...
    case 'caret-up':
      return (
        <svg width={iconSize} height={iconSize} viewBox="0 0 1024 1024" fill="currentColor">
...
const Icon = ({
  ...
  return (
    <span
      ...
      style={{ color, ...style }}
    >
      <IconSvg type={type} size={iconSize} />
    </span>
  );
};
