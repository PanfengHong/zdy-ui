...
const StepsDemo = () => {
  ...
  const demos = [
      ...
      render: (
        <div style={{ display: 'flex', gap: 48 }}>
          <Steps current={1} direction="vertical" style={{ width: 200 }}>
            ...
            <Step title="进行中" description="这个任务正在进行中" />
            <Step title="待处理" description="这个任务待处理" />
            <Step title="最后一个" />
          </Steps>
        </div>
      )
    ...
    {
      title: '垂直方向可切换',
      code: `<Steps current={current} direction="vertical" onChange={setCurrent}>`,
      prepend: (
        <div style={{ marginBottom: 12 }}>
          <span>当前步骤：</span>
    ...
    {
      title: '错误状态',
      code: `<Steps current={1} status="error">`,
      render: (
    ...
    {
      title: '小尺寸',
      code: `<Steps current={2} size="small">`,
      render: (
    ...
    {
      title: '标签在右侧（labelPlacement=horizontal）',
      code: `<Steps current={2} labelPlacement="horizontal">`,
      render: (
    ...
    {
      title: '进度环',
      code: `<Steps current={current} percent={60}>`,
      prepend: (
        <div style={{ marginBottom: 12 }}>
          <button
    ...
    {
      title: '导航模式',
      code: `<Steps current={1} type="navigation" onChange={onChange}>`,
      render: (
